...
void setup() {
  ...
  BEIDOU and QZSS support mode. And DPO(Dynamic power optimization) status*/

  Serial.println("2. Activando modo GNSS...");
  sendATCommand("AT+CGNSSMODE=15,1");
  delay(1000);

  /* This command is used to configure NMEA output sentences which 
  are generated by the gpsOneenginewhen position data is available.*/
