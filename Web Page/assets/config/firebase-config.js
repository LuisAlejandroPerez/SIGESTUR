...
// Default route information when GTFS data is not available
export const DEFAULT_ROUTE_INFO = {
  id: 'LN01',
  shortName: 'Avenida Lincoln',
  longName: 'Avenida Abraham Lincoln - Santo Domingo',
  type: 'bus',
  color: '4CAF50',
};

// Helper function to get route info with fallback
export const getRouteInfoWithFallback = (routeInfo) => {
  if (routeInfo && routeInfo.shortName && routeInfo.shortName !== '') {
    return routeInfo;
  }
