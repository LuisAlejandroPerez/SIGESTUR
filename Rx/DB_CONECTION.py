...
print(db.reference("/gps_data/trip_ID").get())

#update operation (update existing value)
db.reference("/gps_data/trip_ID/C19A").update({"timestamp":"15"})

#update operation (add new key value)
db.reference("/gps_data/trip_ID/C19A").update({"activa":"si"})

# push operation
db.reference("/gps_data/trip_ID/C19A/timestamp").push().set("12345")

# delete operation
db.reference("/gps_data/trip_ID/C19A/activa").delete()